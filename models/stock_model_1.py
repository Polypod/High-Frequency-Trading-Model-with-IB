...
class HftStockModel1(BaseModel):
    ...
    def calculate_signals(self):
        ...
        if self.forex_pair:
            ...
            # Our final trade signals
            self.is_buy_signal = is_up_trend and is_oversold and self.calculate_highs_lows_signal
    ...
    def trim_historical_data(self):
        ...
        self.df_hist_high = self.df_hist_high[self.df_hist_high.index >= cutoff_time]
        self.df_hist_low = self.df_hist_low[self.df_hist_low.index >= cutoff_time]
